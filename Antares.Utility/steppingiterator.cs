...
namespace Antares.Utility
{
    ...
    public static class SteppingUtility
    {
        ...
        /// The underlying collection must implement `IList<T>` to guarantee
        /// efficient random access, matching the constraint of the original
        /// C++ `std::random_access_iterator`.
        /// </remarks>
        /// <example>
        /// <code>

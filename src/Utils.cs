...
namespace Antares
{
   ...
   public static partial class Utils
   {
      ...
      public static void QL_REQUIRE(bool condition, Func<string> message, AntaresExceptionEnum exEnum = AntaresExceptionEnum.ArgumentException)
      {
         if (!condition)
            switch (exEnum)
            {
               case AntaresExceptionEnum.ArgumentException:
                  throw new ArgumentException(message.Invoke());
               case AntaresExceptionEnum.NotTradableException:
                  throw new NotTradableException(message.Invoke());
               case AntaresExceptionEnum.RootNotBracketException:
                  throw new RootNotBracketException(message.Invoke());
               case AntaresExceptionEnum.MaxNumberFuncEvalExceeded:
                  throw new MaxNumberFuncEvalExceeded(message.Invoke());
               case AntaresExceptionEnum.InvalidPriceSignException:
                  throw new InvalidPriceSignException(message.Invoke());
               case AntaresExceptionEnum.NullEffectiveDate:
                  throw new NullEffectiveDateException(message.Invoke());
            }
      }

      public static void QL_FAIL(string message, AntaresExceptionEnum exEnum = AntaresExceptionEnum.ArgumentException)
      {
         switch (exEnum)
         {
            case AntaresExceptionEnum.ArgumentException:

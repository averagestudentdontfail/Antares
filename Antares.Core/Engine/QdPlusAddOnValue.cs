...
namespace Antares.Engine
{
    public class QdPlusAddOnValue
    {
        ...
        public double Evaluate(double z)
        {
            ...
            double boundary_at_T_minus_s = ReconstructBoundary(time_elapsed);
        ...
        private double ReconstructBoundary(double time_elapsed)
        {
            try
            {
                ...
                double boundary_value = _xmax * Math.Exp(-Math.Sqrt(Math.Max(0.0, h_val)));
